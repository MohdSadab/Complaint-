...
<li><a href="http://localhost/newcomplaint.php">NewComplaint</a> </li>
<li><a  class="active" href="http://localhost/allComplaints.php">AllComplaint</a></li>
...
<?php
// if($_SESSION['name'])
 // header("Location:http://localhost/officer.html");	 
 $con=mysqli_connect('localhost','root','sadab') or die(mysqli_error());
